...
type: design
---
Pin Schedule export is LOCKED. Do not re-propose colors, columns, or layout.

- 2 columns only: PIN | DESCRIPTION. No separate Photos column, no Room/Area column by default.
